...
class OnboardingCell: UICollectionViewCell {
    ...
    private let slideTitleLabel: UniversalLabel = {
    ...
    private let slideDescriptionLabel: UniversalLabel = {
        let label = UniversalLabel(font: .systemFont(ofSize: 14, weight: .semibold),
                                   textColor: .black,
                                   text: "")
